...
import br.com.sda.R;
import br.com.sda.ui.CadastroActivity;
import br.com.sda.ui.FavoritosActivity;
import br.com.sda.ui.BuscaActivity;
import br.com.sda.ui.quote.ListActivity;

import static br.com.sda.util.LogUtil.logD;
import static br.com.sda.util.LogUtil.makeLogTag;

/**
 * Classe base para todas Activities.
 * A classe cria e prover a navegação pelo drawer e toolbar .
 * Lógica de navegação em {@link BaseActivity#goToNavDrawerItem(int)}
 *
 */
